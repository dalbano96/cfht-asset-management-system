...
class AssetsController extends AdminController
{
    ...
    public function postCreate()
    {
        ...
        // attempt validation
            ...
            $asset->physical            		= '1';
            $asset->depreciate          		= '0';
# Truncates string to retrieve asset id
	$index = substr($asset->asset_tag, 5);
# Assigns asset id to qr code url
	$asset->_snipeit_qr_code_url = "https://inventory.cfht.hawaii.edu/hardware/{$index}/view";
